...
<input type="hidden" id="supplierListSubmit" name="supplierListSubmit" value="0" />
<div id="supplierTableDiv" class="ui-widget">
    <table id="supplierTable" class="ui-widget ui-widget-content">
        <thead>
            <tr class="ui-widget-header ">
                <th width="20"><input type="checkbox" id="allSupplierId" name="allSupplierId"/></th>
				<th>供应商名称</th>
				<th>主营商品类别</th>
				<th>联系人</th>
				<th>手机</th>
        ...
        <tbody>
			<s:iterator  value="list" var="evt">
				<tr>
					<td width="20"><input type="checkbox" name="supplierId" value="<s:property value='#evt.id'/>"/></td>
