...
<table>
	...
	<tr>
		...
		<td><textarea name="commodityEvt.details" id="commodityDetails" class="text ui-widget-content ui-corner-all" cols="93" rows="5">${commodityEvt.details }</textarea></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><textarea name="commodityEvt.remark" id="commodityRemark" class="text ui-widget-content ui-corner-all" cols="93" rows="5">${commodityEvt.remark }</textarea></td>
	</tr>
</table>
